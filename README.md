...
- **找话说**：针对普通劳动者“开口难”的痛点，应用的讨薪话术生成功能会在用户面对老板拖延和拒绝支付工资情况时候起效，用户可将对方发来的聊天记录作为原始对话输入，便可获得可供复制发送给老板的讨薪话术。
- **存证据**：根据用户提供的事件描述，以及文本、图片、语音资料生成一份维权卷宗，供后续介入法律维权服务时快速对齐和沟通使用。
- **出公函**：针对普通劳动者“追讨难”的痛点，应用支持一键生成“催薪告知书”，导出并发送给老板，营造懂法人设（我也不是好欺负的）。告知书会包含基本信息、催薪事由、法律依据、诉讼时效等必要信息。
- **维权地图**：内置当地劳动维权机构信息。
- **未来展望（找援助）**：如以上方式都无法完成讨薪，期望引入专业催讨、律师、公益律师服务。
